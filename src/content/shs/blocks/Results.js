...
const Results = () => {
  ...
  // State
  const shs = useSelector((state) => state.sh.shs);
  const shState = useSelector((state) => state.sh);
  const page = useSelector((state) => state.sh.page);
  const limit = useSelector((state) => state.sh.limit);
  const count = useSelector((state) => state.sh.count);
  const sortModel = useSelector((state) => state.sh.sortModel);
  const loading = useSelector((state) => state.sh.loading);
  const filters = useSelector((state) => state.sh.filters);
                ...
                renderCell: (params) => {
                  return (
                    <Stack direction="row" spacing={1.25}>
                      ...
                      <Link to={`/shs/edit/${params.row.id}`}>
