...
const Form = (props) => {
  ...
  const initialValues = {
    RegionId: ase.RegionId || '',
    StateId: ase.StateId || '',
    DistrictIds: ase.Districts?.map((district) => district.Id) || [],
    AshId: ase.AshId || '',
    EmpCode: ase.EmpCode || '',
    Name: ase.Name || '',
    Email: ase.Email || '',
    ContactNumber: ase.ContactNumber || '',
...

            {
              ...
              <Grid item xs={12} md={6}>
                <FormikControl
                  ...
                  name="AshId"
                  label='ASH'
                  touched={touched.AshId}
                  error={errors.AshId}
                  value={values.AshId}
                  loadOptions={ashLoadOptions}
                  defaultValue={defaultAshValue}
                  setFieldValue={setFieldValue}
                  setFieldTouched={setFieldTouched}
                  setFieldError={setFieldError}
                />
