...
import { getSoItem } from 'src/slices/so';
import {
  Alert,
  Drawer,
  IconButton,
                ...
                <>
                  ...
                  <Grid item xs={12} md={6} borderBottom="1px solid #ECECEC">
                    <DetailBox
                      icon={<ApartmentIcon color="secondary" />}
                      label="Districts"
                      value={so.Districts.map((district) => district.Name).join(',')}
                    />
                  </Grid>
                  <Grid item xs={12} md={6} borderBottom="1px solid #ECECEC">
                    <DetailBox
                  ...
                  <Grid item xs={12} md={6} borderBottom="1px solid #ECECEC">
                    <DetailBox
                      icon={<QrCodeIcon color="secondary" />}
                      label="ASH"
                      value={`${so.AshEmpCode} ${so.AshName}`}
                    />
                  </Grid>
                  <Grid item xs={12} md={6} borderBottom="1px solid #ECECEC">
                    <DetailBox
                      icon={<QrCodeIcon color="secondary" />}
                      label="ASE"
                      value={`${so.AseEmpCode} ${so.AseName}`}
                    />
                  </Grid>
                  <Grid item xs={12} md={6} borderBottom="1px solid #ECECEC">
                    <DetailBox
