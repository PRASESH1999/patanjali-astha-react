...
const Results = () => {
  ...
  // State
  const sos = useSelector((state) => state.so.sos);
  const soState = useSelector((state) => state.so);
  const page = useSelector((state) => state.so.page);
  const limit = useSelector((state) => state.so.limit);
  const count = useSelector((state) => state.so.count);
  const sortModel = useSelector((state) => state.so.sortModel);
  const loading = useSelector((state) => state.so.loading);
  const filters = useSelector((state) => state.so.filters);
                ...
                renderCell: (params) => {
                  return (
                    <Stack direction="row" spacing={1.25}>
                      ...
                      <Link to={`/sos/edit/${params.row.id}`}>
