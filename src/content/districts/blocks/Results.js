...
const Results = () => {
  ...
  const page = useSelector((state) => state.district.page);
  const limit = useSelector((state) => state.district.limit);
  const count = useSelector((state) => state.district.count);
  const sortModel = useSelector((state) => state.district.sortModel);
                ...
                renderCell: (params) => {
                  return (
                    <Stack direction="row" spacing={1.25}>
                      <Link to={`/districts/${params.row.id}`}>
                      ...
                      <Link to={`/districts/edit/${params.row.id}`}>
